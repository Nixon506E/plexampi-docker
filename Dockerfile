...
RUN wget --no-verbose https://plexamp.plex.tv/headless/Plexamp-Linux-headless-v4.13.1.tar.bz2 && \
  tar xjf Plexamp-Linux-headless-v4.13.1.tar.bz2 -C /root && \
  rm Plexamp-Linux-headless-v4.13.1.tar.bz2
